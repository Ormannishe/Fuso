...
function trafficMap() {
  ...
  // Create 28 Streets
  var edge1 = new Street("Edge 1", node1, node4, 0, "Highway");
  var edge2 = new Street("Edge 2", node1, node2, 0, "Side-road");
  var edge3 = new Street("Edge 3", node4, node5, 0, "Side-road");
  var edge4 = new Street("Edge 4", node2, node6, 0, "Main-road");
  var edge5 = new Street("Edge 5", node5, node6, 0, "Side-road");
  var edge6 = new Street("Edge 6", node3, node2, 0, "Side-road");
  var edge7 = new Street("Edge 7", node3, node7, 0, "Side-road");
  var edge8 = new Street("Edge 8", node7, node6, 0, "Side-road");
  var edge9 = new Street("Edge 9", node6, node8, 0, "Main-road");
  var edge10 = new Street("Edge 10", node8, node9, 0, "Side-road");
  var edge11 = new Street("Edge 11", node5, node9, 0, "Main-road");
  var edge12 = new Street("Edge 12", node5, node10, 0, "Side-road");
  var edge13 = new Street("Edge 13", node4, node10, 0, "Highway");
  var edge14 = new Street("Edge 14", node10, node14, 0, "Highway");
  var edge15 = new Street("Edge 15", node10, node11, 0, "Main-road");
  var edge16 = new Street("Edge 16", node9, node11, 0, "Side-road");
  var edge17 = new Street("Edge 17", node9, node12, 0, "Main-road");
  var edge18 = new Street("Edge 18", node11, node12, 0, "Side-road");
  var edge19 = new Street("Edge 19", node11, node13, 0, "Main-road");
  var edge20 = new Street("Edge 20", node14, node13, 0, "Side-road");
  var edge21 = new Street("Edge 21", node14, node15, 0, "Highway");
  var edge22 = new Street("Edge 22", node15, node16, 0, "Main-road");
  var edge23 = new Street("Edge 23", node13, node16, 0, "Side-road");
  var edge24 = new Street("Edge 24", node16, node17, 0, "Main-road");
  var edge25 = new Street("Edge 25", node13, node17, 0, "Main-road");
  var edge26 = new Street("Edge 26", node18, node17, 0, "Side-road");
  var edge27 = new Street("Edge 27", node12, node18, 0, "Main-road");
  var edge28 = new Street("Edge 28", node12, node13, 0, "Side-road");
